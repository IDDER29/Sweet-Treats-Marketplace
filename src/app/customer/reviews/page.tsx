...
function ReviewCard({
  ...
  function handleSave() {
    ...
    onEdit(review.id, editText.trim(), editRating);
    setEditing(false);
...
export default function MyReviewsPage() {
  ...
  function handleEdit(id: string, text: string, rating: number) {
    setReviews((prev) =>
